...
int gdo0 = D1;  // for esp8266! GDO0 on pin 5 = D1.
int gdo2 = D2;  // for esp8266! GDO0 on pin 5 = D1.
    ...
    ELECHOUSE_cc1101.setGDO(gdo0, gdo2);    // set lib internal gdo pin (gdo0). Gdo2 not use for this example.
